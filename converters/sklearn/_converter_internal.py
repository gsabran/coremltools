...
import _one_hot_encoder
import _dict_vectorizer
import _NuSVC
import _NuSVR
import _SVC
import _SVR
...
import _decision_tree_classifier
import _decision_tree_regressor
import _gradient_boosting_classifier
import _gradient_boosting_regressor
import _logistic_regression
import _normalizer
import _imputer
import _random_forest_classifier
import _random_forest_regressor
import _standard_scaler
...
def _convert_sklearn_model(input_sk_obj, input_features = None,
    ...
    if isinstance(obj_list[0].sk_obj, _dict_vectorizer.sklearn_class):
        ...
        if not isinstance(input_features, (str, unicode)):
        ...
        if len(obj_list) > 1:
            ...
            elif isinstance(output_feature_names, (str, unicode)):
